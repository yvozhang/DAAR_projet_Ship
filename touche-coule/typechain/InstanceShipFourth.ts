...
export interface InstanceShipFourthInterface extends utils.Interface {
  functions: {
...
export interface InstanceShipFourth extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: InstanceShipFourthInterface;
  ...
  functions: {
    ...
    update(
      x_: PromiseOrValue<BigNumberish>,
      y_: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  };
