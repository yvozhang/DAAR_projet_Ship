...
export interface InstanceShipSecInterface extends utils.Interface {
  functions: {
...
export interface InstanceShipSec extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: InstanceShipSecInterface;
