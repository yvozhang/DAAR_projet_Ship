...
export interface InstanceShipThirdInterface extends utils.Interface {
  functions: {
...
export interface InstanceShipThird extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: InstanceShipThirdInterface;
