...
const listShips =[main.myShipFirst(),main.myShipSecond(),main.myShipThird(),main.myShipFourth()]
var indexShip = 0
const Buttons = ({ wallet }: { wallet: ReturnType<typeof useWallet> }) => {
  const next = () => {wallet?.contract.turn()};
  
  const register = () => {
    const address = listShips[indexShip % listShips.length]
    console.log("indexShip:"+indexShip)
