...
import type { InstanceShip } from '$/InstanceShip'
...
export const myShipFirst = () => contracts.InstanceShip.address
export const myShipSecond = () => contracts.InstanceShipSec.address
export const myShipThird = () => contracts.InstanceShipThird.address
export const myShipFourth = () => contracts.InstanceShipFourth.address
